...
#define STRING_CONFIG_H_AUTHOR "(Dust, valerionew, Ender-3, morganestes)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Ender-3 4.2.2 w/Z Thermistor"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "60f7279a-60b1-479f-b7b5-c729b2fba0d5"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  15.7
    #define DEFAULT_Ki   1.05
    #define DEFAULT_Kd  58.2
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 206.5
  #define DEFAULT_bedKi  39.16
  #define DEFAULT_bedKd 727.9
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 142.27 }
...
#define CLASSIC_JERK
  ...
  #define TRAVEL_EXTRA_XYJERK 0.3     // Additional jerk allowance for all travel moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42.8, -4.4, -0.64}
...
#define Y_BED_SIZE 203 // (220 - 16.3)

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -4.7
#define Y_MIN_POS 0 //16.3mm back from the front
#define Z_MIN_POS 0
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 42
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // #define AVOID_OBSTACLES
    ...
    #define CLIP_H  24  // Bed clip height, should be padded a few mm over its physical size
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 15, 20, 35, 15 } // (mm) Left, Front, Right, Back insets
...
// #define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_MIN_TEMP 205
...
#define LCD_FEEDBACK_FREQUENCY_HZ 2255
